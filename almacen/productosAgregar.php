    ...
    <?php
                ...
                if (isset($_REQUEST['guardar'])) {
                    if (isset($_FILES['foto']['name'])) {
                        ...
                        $query = "INSERT INTO productos (nombre  ,precio            ,imagen                 ,tipo,cantidad,ganancia,categoria) values 
                                                         ('" . $_POST['nombre'] . "','" . $_POST['precio'] . "','" . $binariosImagen . "','" . $tipoArchivo . "','" . $_POST['cantidad'] . "','" . $ganancia . "','" . $categoria . "');
                            ";
                ...
                ?>
    <h1 style="margin-top: 12px;margin-bottom:5px;text-align: center;">AGREGAR PRODUCTO</h1>
