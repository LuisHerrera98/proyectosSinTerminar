            ...
            <div class="datos-detalle-producto">
                ...
                <br>
                    ...
                    <div style="display: flex; justify-content: space-around; align-items: center; flex-direction: column;">
                            ...
                            <a style="width:150px;" target="_blank" href="https://api.whatsapp.com/send?phone=542216416297&text=hola%20quiero%20comprar%20el%20producto%0Anombre%20%3A%20<?php echo $row['nombre']?>"><button id="añadir-carrito" class="boton-comprar-detalle">Comprar</button></a>
                    </div>
            </div>
        </div>
        <?php
