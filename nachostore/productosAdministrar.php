...
<header class="header" id="header" >
            ...
            <ul class="menuNavegacion" style="margin-top:5px;">
                    ...
                    <div class="navProductos" style="width:100%; background-color:aliceblue; position:absolute; border-radius:3px; display:none">
                        <ul class="menuNavegacion" style="margin-top:5px; color:black; border-radius:5px;"> 
                            ...
                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=buzos">BUZOS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=sweaters">SWEATERS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=camperas">CAMPERAS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=parkas">PARKAS</a></li>
                            ...
                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=joggers">JOGGERS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=chinos">CHINOS/VESTIR</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=camisas">CAMISAS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=zapatillas">ZAPATILLAS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=musculosas">MUSCULOSAS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=joggins">JOGGINS</a></li>

                            <li class="li-productos"><a href="productosCategoriaEditar.php?categoria=conjuntos">CONJUNTOS</a></li>
    ...
    <main class="main-final">
        ...
        <a href=""><div><p>CREAR PRODUCTO</p></div></a>
        </div>
            ...
            <div class="row">
                <div class="col s12 div-final">
                    ...
                    <div class="carousel-item">
                            ...
                            <a href="productosCategoriaEditar.php?categoria=remeras"><img src="imagenesCarrusel/remera2.jpeg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Camisas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=camisas"><img src="imagenesCarrusel/camisa1.jpeg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Camperas</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=camperas"><img src="imagenesCarrusel/campera1.jpeg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Buzos</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=buzos"><img src="imagenesCarrusel/buzo1.jpeg" alt=""></a>
                        </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=sacos"><img src="imagenesCarrusel/saco1.jpg" alt=""></a>
                        </div>

                        <div class="carousel-item">
                            <h2 class="subtitulo">Chalecos</h2>
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=chalecos"><img src="imagenesCarrusel/chaleco1.jpg" alt=""></a>
                        </div>
                        ...
                        <div class="carousel-item">
                            ...
                            <div class="linea-division"></div>
                            <a href="productosCategoriaEditar.php?categoria=jeans"><img src="imagenesCarrusel/jean1.jpeg" alt=""></a>
                        </div>
